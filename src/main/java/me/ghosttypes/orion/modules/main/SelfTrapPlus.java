...
public class SelfTrapPlus extends Module {
    ...
    private final ArrayList<Vec3i> full = new ArrayList<>() {{
        add(new Vec3i(0, 2, 0));
        add(new Vec3i(1, 1, 0));
        add(new Vec3i(-1, 1, 0));
        add(new Vec3i(0, 1, 1));
    ...
    private final ArrayList<Vec3i> antiFacePlace = new ArrayList<>() {{
        add(new Vec3i(1, 1, 0));
        add(new Vec3i(-1, 1, 0));
        add(new Vec3i(0, 1, 1));
        add(new Vec3i(0, 1, -1));
    ...
    private void onRender(Render3DEvent event) {
        ...
        for (Vec3i b: getTrapDesign()) {
            BlockPos ppos = mc.player.getBlockPos();
            BlockPos bb = ppos.add(b.getX(), b.getX(), b.getZ());
    ...
    private ArrayList<Vec3i> getTrapDesign() {
        ArrayList<Vec3i> trapDesign = new ArrayList<>();
        switch (mode.get()) {
