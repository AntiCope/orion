// taken from boat phase from meteor rejects and boat fly from meteor client 
//    writen / modified by MrBreakNFix
// tested on Specterium.com
...
public class BoatPhasePlus extends Module {
    ...
    public BoatPhasePlus() {
        super(Categories.Movement, "boat-phase-plus", "Bypasses certain anticheats, dont go out of render distance, if you do try \".dismount\"");
    }
    @Override
    ...
    private void onReceivePacket(PacketEvent.Receive event) {
        if (event.packet instanceof VehicleMoveS2CPacket && (true)) {
            event.cancel();
        }
    }
}
